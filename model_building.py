# -*- coding: utf-8 -*-
"""
Created on Tue Jul 27 17:51:37 2021
...
df_model = df[['avg_salary','Rating','Size','Type of ownership','Industry',
               ...
               'excel','job_cate','seniority','desc_len']]

# get dummy data for categorical cols
...
model = sm.OLS(y,X_sm)
model.fit().summary()
# >>> R_squared = 0.708: model explains about 70% of variations in glassdoor salary.
...
# nice to have: gradient boosted tree
# nice to have: SVM
